...
input_data_norm = np.concatenate([minmax_scale(input_data, axis=0), input_data_dummies], axis=1)
...
# b = []
# c = []
# for i in range(len(value_hist_train)):
#     if value_hist_train[i] > 1 and value_hist_test[i] > 1 and value_hist_cv[i] > 1:
#         a.append(value_hist_train[i])
#         b.append(value_hist_test[i])
#         c.append(value_hist_cv[i])
#
# pl.scatter(b, c)